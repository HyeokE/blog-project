...
const HomePage = async () => {
  ...
  return (
    <div className="flex h-[100vh] w-[100vw] flex-col items-center justify-center gap-8">
      ...
      <PostFadeBlur>
        <div className="tablet:gap-6 flex h-[100vh] flex-row items-center justify-center gap-1 overflow-hidden px-5">
          ...
          <div className="relative flex h-[100vh] max-w-[612px] flex-col gap-8">
            {/* Post Point Border  */}
