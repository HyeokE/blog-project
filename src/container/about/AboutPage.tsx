...
const AboutPage = () => {
  return (
    <div className="relative min-h-dvh min-w-dvw overflow-hidden dark:bg-gray-950">
      <div className="mx-auto max-w-3xl px-6 py-16 sm:px-8 sm:py-24">
        ...
        <header className="mb-20">
          <h1 className="mb-8 text-5xl font-extrabold text-black dark:text-white">ABOUT.</h1>
          <p className="mb-2 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          <section className="rounded-lg">
            ...
            <div className="mb-16">
              <div className="mb-4 flex items-baseline justify-between">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">2023.05 - 현재</span>
              </div>
              <p className="mb-6 text-gray-600 dark:text-gray-300">Frontend Developer</p>
              ...
              <div className="mb-8">
                ...
                <ul className="mb-6 space-y-1">
                  <li className="flex">
                    <span className="mr-4 text-gray-400">-</span>
                    <p className="text-gray-700 dark:text-gray-300">
                      코드 상 버그가 자주 발생하는 문제를 해결하기 위해 테스트 라이브러리를 도입하고
            ...
            <div className="mb-16">
              <div className="mb-4 flex items-baseline justify-between">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">2023.01 - 2024.05</span>
              </div>
              <p className="mb-6 text-gray-600 dark:text-gray-300">Frontend Developer</p>
                ...
                <ul className="mb-6 space-y-1">
                  <li className="flex">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      ...
                      <br />
                      Figma에서 디자인 토큰 편집시 npm 라이브러리에도 변경사항이 자동으로 반영되도록
                      CI/CD를 구축했습니다.
                    </p>
                  </li>
                  <li className="flex">
          ...
          <section className="mb-20">
            ...
            <div className="mb-16">
              ...
              <ul className="mb-6 space-y-1">
                ...
                <li className="flex">
                  <span className="mr-4 text-gray-400">-</span>
                  <p className="text-gray-700 dark:text-gray-300">포지션 별 지원하기 기능 개발</p>
                </li>
                <li className="flex">
                  <span className="mr-4 text-gray-400">-</span>
                  <p className="text-gray-700 dark:text-gray-300">
            ...
            <div className="mb-16">
              <div className="mb-4 flex items-baseline justify-between">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">2022.8 - 2022.12</span>
              </div>
              ...
              <ul className="mb-6 space-y-1">
                ...
                <li className="flex">
                  <span className="mr-4 text-gray-400">-</span>
                  <p className="text-gray-700 dark:text-gray-300">token type 지정</p>
                </li>
                <li className="flex">
                  <span className="mr-4 text-gray-400">-</span>
                  <p className="text-gray-700 dark:text-gray-300">
                ...
                <li className="flex">
                  <span className="mr-4 text-gray-400">-</span>
                  <p className="text-gray-700 dark:text-gray-300">npm package 배포</p>
                </li>
              </ul>
            </div>
          ...
          <section className="mb-20">
            ...
            <div className="mb-16">
              <div className="mb-2 flex items-baseline justify-between">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">2023.03 - 현재</span>
              </div>
              <p className="mb-6 text-gray-600 dark:text-gray-300">Organizer</p>
            ...
            <div>
              <div className="mb-2 flex items-baseline justify-between">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">2021.08 - 2023.07</span>
              </div>
              <p className="mb-6 text-gray-600 dark:text-gray-300">Lead</p>
                ...
                <li className="flex">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-700 underline hover:text-black dark:text-gray-300 dark:hover:text-white"
                    >
                      2023 프론트엔드 트렌드 따라잡기
                    </a>
                  </p>
