    ...
    <div className="font-suit bg-cloud-dancer/60 relative min-h-dvh min-w-dvw overflow-hidden dark:bg-cloud-dancer/60">
      <div className="mx-auto max-w-3xl px-6 py-12 sm:px-8 sm:py-8">
        ...
        <header className="mb-20">
          ...
          <p className="text-brand-700 text-lg leading-relaxed dark:text-card-foreground">
        ...
        <div className="space-y-16">
          ...
          <section className="rounded-lg">
            <div className="mb-6 flex items-center">
              <h2 className="text-brand-900 text-2xl font-bold dark:text-foreground">
                WORK EXPERIENCE.
              </h2>
            </div>
            ...
            <div className="mb-16">
              <div className="mb-4 flex items-baseline justify-between">
                <h3 className="text-xl font-bold text-black dark:text-foreground">SkinSeoul</h3>
                <span className="text-brand-500 text-sm dark:text-muted-foreground">
                  (Singapore) 2025.02 - Present
                </span>
              </div>
              <p className="text-brand-600 mb-6 dark:text-brand-700">Software Engineer</p>
              <div className="mb-8">
            ...
            <div className="mb-16">
              <div className="mb-4 flex items-baseline justify-between">
                <h3 className="text-xl font-bold text-black dark:text-foreground">쿼타랩</h3>
                <span className="text-brand-500 text-sm dark:text-muted-foreground">
              ...
              <div className="mb-8">
                ...
                <ul className="mb-6 space-y-1">
                  <li className="flex">
                    ...
                    <p>
                      <span className="text-brand-700 font-medium dark:text-card-foreground">
                        동작 버그가 잦아 신뢰도가 낮아진 디자인 시스템을 개선
                      </span>
                      <br />
                      <span className="text-brand-700 font-light dark:text-card-foreground">
            ...
            <div className="mb-16">
              <div className="mb-4 flex items-baseline justify-between">
                <h3 className="text-xl font-bold text-black dark:text-foreground">샤플앤컴퍼니</h3>
                <span className="text-brand-500 text-sm dark:text-muted-foreground">
          ...
          <section className="mb-20">
            ...
            <div className="mb-16">
              <div className="mb-4 flex items-baseline justify-between">
                <h3 className="text-xl font-bold text-black dark:text-foreground">GDSC DJU Web</h3>
                <span className="text-brand-500 text-sm dark:text-muted-foreground">
              ...
              <div className="mb-4 flex space-x-6">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-brand-500 text-sm underline hover:text-black dark:text-muted-foreground dark:hover:text-foreground"
                >
                  GitHub
                </a>
                <a
          ...
          <section className="mb-20">
            ...
            <div>
              ...
              <ul className="mb-6 space-y-1">
                <li className="flex">
                  <span className="mr-4 text-gray-400">-</span>
                  <p className="text-brand-700 dark:text-card-foreground">
          ...
          <section className="mb-20">
            ...
            <ul className="space-y-1">
              <li className="flex">
                <span className="mr-4 text-gray-400">-</span>
                <p className="text-brand-800 dark:text-card-foreground">
